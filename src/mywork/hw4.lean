...
/-
Answer: If P and (Q and R) is true, then P is true, and (Q and R) is
...
If we say that (P and (Q and R) is false) --> ((P and Q) and R is true),
then 
-/
...
begin
  ...
  assume P Q R,
  let ae1: P := and.elim_left and_associative,
  let ae2: (Q ∧ R) := and.elim_right and_associative,
  let ae3: Q := and.elim_left ae2,
  let ae4: R := and.elim_right ae2,
end
